    ...
    init(rowsCount, colsCount) {
        ...
        for (let row = 0; row < rowsCount; row++) {
            ...
            for (let col = 0; col < colsCount; col++) {
                ...
                this.cells[`x${col}_y${row}`] = td; // x1_y2
                tr.appendChild(td);
            }
        }
    },
...
const snake = {
    ...
    isOnPoint(point) {
        return this.getBody()
            .some(snakePoint => snakePoint.x === point.x && snakePoint.y === point.y);
    },

    makeStep() {
        this.lastStepDirection = this.direction;
        // [a, b, c]
        // [{x: 10, y: 10}, {x: 10, y: 11}, {x: 10, y: 12}] ===> [{x: 9, y: 10}, {x: 10, y: 10}, {x: 10, y: 11}]
    ...
    growUp() {
        // food {x: 9, y: 10}
        // [{x: 10, y: 10}, {x: 10, y: 11}, {x: 10, y: 12}] ===> [{x: 10, y: 10}, {x: 10, y: 11}, {x: 10, y: 12}, {x: 10, y: 12}]
        // [{x: 10, y: 10}, {x: 10, y: 11}, {x: 10, y: 12}, {x: 10, y: 12}] ===> [{x: 9, y: 10}, {x: 10, y: 10}, {x: 10, y: 11}, {x: 10, y: 12}]
